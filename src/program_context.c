  ...
  static struct option long_options[] =
    {
      ...
      {"cell-size", required_argument, NULL, 's'},
      {"border-colour", required_argument, NULL, 'b'},
      ...
      {"b-rule", required_argument, NULL, 0},
      {"s-rule", required_argument, NULL, 0},
      {0, 0, 0, 0}
    };
   ...
   while (ret)
     {
     int option_index = 0;
     opt = getopt_long (argc, argv, "vl:w:h:x:y:f:t:c:p:m:i:s:b:e",
     ...
     switch (opt)
       ...
       case 0:
         if (strcmp (long_options[option_index].name, "help") == 0)
           ...
           program_context_put_boolean (self, "erase", TRUE);
         ...
         else if (strcmp (long_options[option_index].name, "cell-size") == 0)
           program_context_put_integer (self, "cell-size", atoi (optarg)); 
         else if (strcmp (long_options[option_index].name, "percent") == 0)
           program_context_put_integer (self, "percent", atoi (optarg)); 
         else if (strcmp (long_options[option_index].name, "max-cycles") == 0)
           program_context_put_integer (self, "max-cycles", atoi (optarg)); 
         else if (strcmp (long_options[option_index].name, "interval") == 0)
           program_context_put_integer (self, "interval", atoi (optarg)); 
         else if (strcmp (long_options[option_index].name, "fbdev") == 0)
           program_context_put (self, "fbdev", optarg); 
         else if (strcmp (long_options[option_index].name, 
               "border-colour") == 0)
           program_context_put (self, "border-clour", optarg); 
         else if (strcmp (long_options[option_index].name, "colour") == 0)
           program_context_put (self, "colour", optarg); 
         else if (strcmp (long_options[option_index].name, "b-rule") == 0)
           program_context_put (self, "b-rule", optarg); 
         else if (strcmp (long_options[option_index].name, "s-rule") == 0)
           program_context_put (self, "s-rule", optarg); 
         else
           exit (-1);
         break;
       case '?': 
       ...
       case 'e': 
         program_context_put_boolean (self, "erase", TRUE); break;
       ...
       case 't': program_context_put_integer (self, "transparency", 
           atoi (optarg)); break;
       case 's': program_context_put_integer (self, "cell-size", 
           atoi (optarg)); break;
       case 'p': program_context_put_integer (self, "percent", 
           atoi (optarg)); break;
       case 'm': program_context_put_integer (self, "max-cycles", 
           atoi (optarg)); break;
       case 'i': program_context_put_integer (self, "interval", 
           atoi (optarg)); break;
       case 'f': program_context_put (self, "fbdev", 
           optarg); break;
       case 'c': program_context_put (self, "colour", 
           optarg); break;
       case 'b': program_context_put (self, "border-colour", 
           optarg); break;
       default:
         ret = FALSE; 
       }
